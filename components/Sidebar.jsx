...
import { 
  GiDungeonGate, GiOpenBook, GiChest, GiDeathSkull, 
  GiHandTruck, GiScrollUnfurled, GiDiceTwentyFacesTwenty,
  GiShop, GiTabletopPlayers // <-- Nuevo icono para mesas
} from 'react-icons/gi';
    ...
    <>
      <aside className="h-screen w-24 md:w-28 flex-shrink-0 flex flex-col items-center py-6 z-[110] relative">
        ...
        <nav className="relative z-10 flex-1 w-full overflow-y-auto no-scrollbar flex flex-col items-center gap-6 md:gap-8 py-4">
            ...
            {/* NUEVO: ACCESO A RENTA DE MESAS */}
            <SidebarIcon icon={<GiTabletopPlayers />} active={activeTab === 'tables'} onClick={() => setActiveTab('tables')} label="Renta de Mesas" />
      ...
      {/* Estilos inyectados de forma segura para React */}
